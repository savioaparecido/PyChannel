...
class Janela1:
    def __init__(self, Tk):
        ...
        '''Recebe o coeficiente de Rugosidade de Mannig'''
        self.lb4 = Label(self.frame1, text='Selecionar Coeficiente de Rugosidade de Manning : ')
        self.lb4['fg'] = 'black'
        ...
        self.bt2 = Button(self.frame4, text='CALCULAR', command=self.calculo1)
        self.bt2['bg'] = 'red'
        self.bt2['fg'] = 'white'
    ...
    def selecionar(self):
        ...
        self.l_materiais = ['Alvenaria de pedra argamassada', 'Alvenaria de pedra aparelhada',
                            ...
                            'Condutos de prancha de madeira aplainada', 'Gabião', 'Superfícies de argamassa de cimento',
    ...
    def calculo1(self):
        '''Passando e Calculando as Variáveis'''
        ...
        self.q = (((self.i ** (3 / 2)) * (self.h ** 8)) / (9 * (self.n ** 3))) ** (1 / 3)


        '''Escrevendo o Resultado'''
        self.lb3 = Label(self.frame5, text=f'A vazão desta seção quadrada (Q) é {self.q:.4f} m³/s')
        self.lb3['fg'] = 'black'
